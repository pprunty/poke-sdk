...
CHIKORITA_POKEMON = {
    ...
    "sprites": {
        ...
        "versions": {
            "generation-ii": {
                "gold": {
                    "front_default": "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-ii/gold/152.png"
                },
                "silver": {
                    "front_default": "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-ii/silver/152.png"
                },
            }
        },
    },
...
CYNDAQUIL_POKEMON = {
    ...
    "sprites": {
        ...
        "versions": {
            "generation-ii": {
                "gold": {
                    "front_default": "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-ii/gold/155.png"
                },
                "silver": {
                    "front_default": "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-ii/silver/155.png"
                },
            }
        },
    },
...
TOTODILE_POKEMON = {
    ...
    "sprites": {
        ...
        "versions": {
            "generation-ii": {
                "gold": {
                    "front_default": "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-ii/gold/158.png"
                },
                "silver": {
                    "front_default": "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-ii/silver/158.png"
                },
            }
        },
    },
...
async def test_pokedex_rankings_async():
    ...
    async with AsyncPoke() as client:
        with respx.mock() as router:
            ...
            rows = await client.pokedex.rankings(
                pokedex="original-johto", concurrency=3
            )
...
def test_sprite_preference_sync():
    ...
    try:
        with respx.mock() as router:
            ...
            rows = client.pokedex.rankings(
                pokedex="original-johto", sprite_preference="gold"
            )
