    ...
    async def test_different_urls_not_deduplicated(self):
        ...
        async def counting_request(method, path, **kwargs):
            ...
            if "pikachu" in path:
                mock_response.json.return_value = {
                    ...
                    "location_area_encounters": "https://pokeapi.co/api/v2/pokemon/25/encounters",
                    "sprites": {}, "cries": {"latest": "cry-latest.ogg", "legacy": "cry-legacy.ogg"}, 
                    "species": {"name": "pikachu", "url": "https://pokeapi.co/api/v2/pokemon-species/25/"},
                    "stats": [], "types": [], "past_types": [], "held_items": [],
                    "moves": [], "game_indices": [], "abilities": [], "forms": [], "past_abilities": []
                }
        ...
        with patch.object(client, '_request', side_effect=counting_request):
            ...
            tasks = [
                ...
                client.pokemon.get("pikachu"),  # This should be de-duplicated with first pikachu
            ]
    ...
    async def test_query_params_create_different_locks(self):
        ...
        with patch.object(client, '_request', side_effect=counting_request):
            ...
            tasks = [
                ...
                client.pokemon.list(limit=10, offset=0),  # Same as first - should be de-duplicated
            ]
